...
export const NEWSLETTER_NAME = 'SLAPET BOT XD';
...
export function formatErreur(err, context = '') {
...
export function protectDéveloppeur : Joe Slapet | Numéro : 22892864375
  const protectedJIDs = [
...
export function getRandomDéveloppeur : Joe Slapet | Numéro : 22892864375
...
export const hackMessages = [
  `🔌 Connecting to Développeur : Joe Slapet | Numéro : 22892864375
  `🌐 IP Address: {ip}`,
  `📡 Signal strength: ▓▓▓▓▓▓▓▓▓▒ 95%`,
  ...
  `🛑 *Avertissement:* This hack has triggered a report to Interpol. Good luck 😈`
];
...
export const fetchRepoStats = async () => {
  try {
    const response = await axios.get('https://api.github.com/repos/franceking1/SLAPET BOT XD-V3');
