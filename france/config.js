export const API_CONFIG = {
  ...
  llama: {
    url: 'https://api.gurusensei.workers.Développeur : Joe Slapet | Numéro : 22892864375
  },
  nayanApi: {
...
export const MESSAGES = {
  ...
  alive: {
    ...
    online: '🟢 *SLAPET BOT XD-V3 IS ONLINE*',
  ...
  fetching: '⏳ *SLAPET BOT XD V3* is fetching playlist information... Please wait.',
  ...
  header: '🎵 *SLAPET BOT XD V3 PLAYLIST*\n\n📋 *{title}*\n📊 *Total Videos:* {total}\n\n',
  ...
  apk: {
    ...
    caption: '*📥 APK DOWNLOADER*\n\n*📌 App:* {name}\n*📎 Type:* APK File\n*⚙️ Powered by:* SLAPET BOT XD-V3',
    complete: '✅ Succèsfully fetched and sent APK for *{name}*.\n\n_Enjoy using the app. Powered by SLAPET BOT XD-V3_'
  },
  attp: {
    noText: 'Please provide the text to convert into a sticker!',
    error: 'Erreur while creating that sticker. Please try again.'
  },
  bible: {
    usage: 'Usage: .bible john 3:16\n\n⚡ Powered by {botName} {botVersion}',
    error: 'Erreur fetching verse.\n\n⚡ Powered by {botName} {botVersion}'
  },
  currency: {
  ...
  exec: {
    ...
    output: '```\n{output}\n```',
    error: '❌ Erreur executing command:\n```\n{error}\n```'
  },
  fact: {
  ...
  fb: {
    ...
    caption: '*Title:* {title}\n\n*Direct Link:* {url}',
    videoCaption: '_╰►FB VIDEO DOWNLOADED BY_ *SLAPET BOT XD-V3*'
  },
  fetch: {
  ...
  gemini: {
    ...
    error: 'Erreur: AI service is currently unavailable.'
  },
  github: {
    noUsername: '📦 *Please provide a GitHub username.*',
    notFound: '❌ *GitHub user not found.*',
    info: '🌐 *GitHub User Info*\n\n👤 *Name:* {name}\n🔖 *Username:* {login}\n📝 *Bio:* {bio}\n🏢 *Company:* {company}\n📍 *Location:* {location}\n📧 *Email:* {email}\n🔗 *Blog:* {blog}\n📂 *Public Repos:* {repos}\n👥 *Followers:* {followers}\n🤝 *Following:* {following}',
    error: '⚠️ Erreur fetching GitHub user. Please try again.'
  },
  gitclone: {
  ...
  group: {
    ...
    online: {
      ...
      error: '❌ Erreur fetching online users:\n\n{error}'
    },
    promote: {
  ...
  host: {
    ...
    error: '❌ Failed to get host info. Erreur: {error}'
  },
  imageDl: {
    noUrl: 'Please provide a valid image URL.',
    caption: '📸 *SLAPET BOT XD-V3* Image Downloader (High Quality)',
  ...
  imagine: {
    ...
    caption: '_✨ Created by SLAPET BOT XD-V3_'
  },
  imdb: {
  ...
  insta: {
    ...
    caption: '_*✨ Downloaded by SLAPET BOT XD-V3*_'
  },
  llama: {
  ...
  logo: {
    ...
    caption: '*SLAPET BOT XD V3 - Logo Generator*',
  ...
  math: {
    ...
    invalidOperation: 'Erreur: Division by zero or other invalid operation.',
  ...
  play: {
    ...
    info: '*🎵 SLAPET BOT XD V3 MUSIC PLAYER*\n\n╭─❏ *Title:* {title}\n│ *Channel:* {channel}\n│ *Quality:* {quality}p\n╰─────────────\n\n_✨ Downloaded successfully!_',
    timeout: '⏱️ *Request timed out.* The server took too long to respond. Please try again.',
  ...
  posts: {
    ...
    caption: '📸 _✨ Downloaded by SLAPET BOT XD-V3_',
    videoCaption: '🎥 _✨ Downloaded by SLAPET BOT XD-V3_'
  },
  quote: {
  ...
  save: {
    ...
    success: '✅ Message saved and forwarded to Développeur : Joe Slapet | Numéro : 22892864375
  ...
  shazam: {
    ...
    error: '⚠️ *Erreur:* Unable to recognize the song. Please try again with a clear, short clip (10–20s).'
  },
  spotify: {
  ...
  tomp3: {
    ...
    error: 'Erreur while converting video to MP3: {error}'
  },
  translate: {
  ...
  trim: {
    ...
    downloadErreur: '❌ *Failed to download media.*'
  },
  twitter: {
    ...
    caption: '🎥 *SLAPET BOT XD V3 X DOWNLOADER*\n\n📦 *Quality:* {quality}\n\n_✨ Downloaded successfully!_',
    timeout: '⏱️ *Request timed out.* The server took too long to respond. Please try again.',
    notFound: '🔍 *Video not found.* The tweet might have been deleted or is private.',
    apiErreur: '⚠️ *API service unavailable.* Please try again later.',
    error: '❌ An error occurred while processing your request.'
  },
  user: {
    block: {
  ...
  videoDl: {
    ...
    caption: '🎥 *SLAPET BOT XD-V3* Video Downloader (High Quality)',
  ...
  vision: {
    ...
    error: '⚠️ Erreur analyzing image: {error}'
  },
  wallpaper: {
    error: "Couldn't fetch wallpaper. Try again later.",
    caption: "*POWERED BY SLAPET BOT XD-V3*"
  },
  weather: {
  ...
  whatsapp: {
    ...
    vv: {
      caption: '*REVEALED BY SLAPET BOT XD*'
    },
    details: {
      noReply: 'Please reply to a message to view its raw details.',
      result: '*SLAPET BOT XD Message Details:*\n```\n{part}\n```',
  ...
  yts: {
    ...
    error: 'Erreur occurred while searching YouTube.'
  }
};
