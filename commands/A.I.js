...
export const commands = [
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      ...
      try {
        ...
        await sock.sendMessage(from, { text: formatErreur(err, MESSAGES.deepseek.error) });
      }
    }
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      ...
      try {
        ...
        await sock.sendMessage(from, { text: formatErreur(err, 'Erreur generating image') });
      }
    }
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      ...
      try {
        ...
        console.error('AI API Erreur:', err.message);
  ...
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      ...
      try {
        ...
        console.error('LLaMA API Erreur:', error);
  ...
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      try {
        ...
        console.error('Erreur fetching joke:', error.message);
  ...
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      try {
        ...
        console.error('Trivia Erreur:', error.message);
  ...
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      try {
        ...
        console.error('Inspire Erreur:', error.message);
  ...
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      ...
      try {
        ...
        console.error('Pairing Code Erreur:', error);
  ...
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      try {
        ...
        console.error('Wallpaper Erreur:', error);
  ...
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      try {
        ...
        console.error('Random Wallpaper Erreur:', error);
