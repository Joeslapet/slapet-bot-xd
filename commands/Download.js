...
export const commands = [
  ...
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      ...
      const caption = MESSAGES.tiktok.caption.replace('{title}', response.title || 'SLAPET BOT XD V3');
  ...
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      ...
      try {
        ...
        console.error('Video-DL Erreur:', error);
        await sock.sendMessage(from, {
  ...
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      ...
      try {
        ...
        await sock.sendMessage(from, {
          video: { url: result.sd },
          caption: '_╰►FACEBOOK VIDEO DOWNLOADED BY_ *SLAPET BOT XD-V3*'
        });
      } catch (error) {
        await sock.sendMessage(from, {
          text: error.toString()
  ...
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      ...
      try {
        ...
        console.error('GitClone Erreur:', error);
        await sock.sendMessage(from, { 
  ...
  },
{
  ...
  execute: async ({ sock, from, text, msg }) => {
    ...
    try {
      ...
      console.error('MediaFire Erreur:', err);
      await sock.sendMessage(from, {
...
}, 
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      ...
      try {
        ...
        console.error('APK Erreur:', error);
        await sock.sendMessage(from, {
  ...
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      ...
      try {
        ...
        return sock.sendMessage(from, {
          text: `❌ Erreur fetching content: ${err.message}`
        });
      }
    }
  }
