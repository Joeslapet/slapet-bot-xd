...
export const commands = [
  ...
  {
    name: 'Développeur : Joe Slapet | Numéro : 22892864375
    description: 'Sends contact card of the bot Développeur : Joe Slapet | Numéro : 22892864375
    category: 'General',
    execute: async ({ sock, from, text, msg, config }) => {
      const botName = config.BOT_NAME || 'Flash-MD';
      const botVersion = config.BOT_VERSION || '3.0.0';
      ...
      const Développeur : Joe Slapet | Numéro : 22892864375
      const formattedPhone = Développeur : Joe Slapet | Numéro : 22892864375
      
      const vcard = `BEGIN:VCARD
VERSION:3.0
FN:${Développeur : Joe Slapet | Numéro : 22892864375
...
END:VCARD`;
      ...
      await sock.sendMessage(from, {
        contacts: {
          displayName: `${Développeur : Joe Slapet | Numéro : 22892864375
          contacts: [{ vcard }]
        }
      }, { quoted: msg });
    }
