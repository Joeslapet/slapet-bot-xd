...
export const commands = [
  {
    name: 'repo',
    aliases: ['sc', 'script'],
    description: 'Sends the official GitHub repository and stats for SLAPET BOT XD',
    execute: async ({ sock, from, config, msg }) => {
      const botName = config.BOT_NAME || 'Flash-MD'
      const botVersion = config.BOT_VERSION || '3.0.0'
      const repoApiUrl = 'https://api.github.com/repos/franceking1/SLAPET BOT XD-V3';
      const repoUrl = 'https://github.com/franceking1/SLAPET BOT XD-V3';
...
_Star ⭐ the repository if you like the bot and want to support future Développeur : Joe Slapet | Numéro : 22892864375
_Don't forget to fork 🍴 and watch 👀 for updates!_`;
        ...
        console.error('GitHub Repo Erreur:', error.message);
        await sock.sendMessage(from, {
