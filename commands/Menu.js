...
export const commands = [
  {
    ...
    execute: async ({ sock, from, msg, commands, config }) => {
      try {
        ...
        menuText += `┃ 👑 *Développeur : Joe Slapet | Numéro : 22892864375
        ...
        await sock.sendMessage(from, { text: '❌ Erreur loading menu.' }, { quoted: msg })
      }
    }
  },
  {
    ...
    execute: async ({ sock, from, text, msg, commands, config }) => {
      try {
        ...
        await sock.sendMessage(from, { text: '❌ Erreur loading help.' }, { quoted: msg })
      }
    }
  }
]
