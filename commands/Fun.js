import { 
  ...
  imdbSearch,
  emojimix,
  getRandomDéveloppeur : Joe Slapet | Numéro : 22892864375
  getFakeFiles,
  randomIP,
  progressSteps,
  hackMessages,
  ...
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      ...
      try {
        ...
        return sock.sendMessage(from, {
          text: MESSAGES.emomix.apiErreur.replace('{error}', err.message)
        }, { quoted: msg });
      }
    }
  },
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      ...
      if (Développeur : Joe Slapet | Numéro : 22892864375
        return sock.sendMessage(from, {
          text: MESSAGES.hack.Développeur : Joe Slapet | Numéro : 22892864375
        }, { quoted: msg });
      }
      ...
      for (const line of hackMessages) {
        ...
        if (line.includes('{Développeur : Joe Slapet | Numéro : 22892864375
          message = line.replace('{Développeur : Joe Slapet | Numéro : 22892864375
