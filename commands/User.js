...
import { formatJid, getSenderJid, MESSAGES, protectDéveloppeur : Joe Slapet | Numéro : 22892864375
...
export const commands = [
  {
    ...
    execute: async ({ sock, from, text, msg }) => {
      ...
      if (protectDéveloppeur : Joe Slapet | Numéro : 22892864375
      ...
      if (text === 'on') {
        ...
        fetchInterval = setInterval(async () => {
          try {
            ...
            const bio = `SLAPET BOT XD: ${data.fact}`;
            await sock.query({
              tag: 'iq',
              attrs: { to: S_WHATSAPP_NET, type: 'set', xmlns: 'status' },
